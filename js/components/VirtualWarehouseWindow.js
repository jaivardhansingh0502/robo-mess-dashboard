// ROBOMESS - 3D Virtual Warehouse Window (Digital Twin)
// Real-time 3D WebGL perspective, multi-camera director, 3D AMRs, racks, and CCTV telemetry

import { RobotState } from '../simulation/types.js';
...
export class VirtualWarehouseWindow {
            ...
            <div class="virtual-window-card">
                <div class="virtual-window-header">
                    ...
                    <div class="vw-meta-group">
                        <span class="mono" id="vw-cam-coord">CAM: (16, 26, 24)</span>
                    </div>
                </div>
                ...
                <div class="virtual-window-viewport" id="vw-viewport-mount">
                    ...
                    <div class="vw-cctv-overlay">
                        ...
                        <div class="cctv-bottom-row">
                            ...
                            <span class="cctv-status">3D TWIN: <strong class="green">SYNCHRONIZED</strong></span>
                        </div>
                    </div>
                </div>
            </div>
    ...
    setupScene() {
        ...
        const ambientLight = new THREE.AmbientLight(0x1B263B, 2.0);
        ...
        const warmLight = new THREE.DirectionalLight(0xFF9F0A, 0.9);
    ...
    buildWarehouseEnvironment() {
        ...
        // 3. Storage Racks (3D Volumetric Racks)
    ...
    setupCameraControls() {
        ...
        camBtns.forEach((btn) => {
            btn.addEventListener('click', () => {
                ...
                this.setCameraMode(btn.getAttribute('data-mode'));
            });
        });
        ...
        window.addEventListener('mousemove', (e) => {
            if (!isDragging || this.cameraMode === 'FOLLOW_AMR') return;
    ...
    updateCameraFollow(delta) {
        if (this.cameraMode !== 'FOLLOW_AMR') return;
