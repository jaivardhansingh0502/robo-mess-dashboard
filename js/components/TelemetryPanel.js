// ROBOMESS - Real-Time Telemetry & Fleet Status HUD Panel
// Displays live metrics, individual AMR telemetry cards, battery meters, and inspector
...
export class TelemetryPanel {
    ...
    render() {
        this.container.innerHTML = `
            <div class="telemetry-hud-wrapper">
                ...
                <!-- Individual Robot Telemetry Cards -->
                <div class="fleet-cards-container">
                    ...
                    <div class="robot-cards-list" id="robot-cards-list">
                        <!-- Populated dynamically -->
                    </div>
                </div>

                <!-- Selected Robot Detailed Inspector -->
                <div class="inspector-card" id="robot-inspector">
                    <!-- Populated dynamically -->
                </div>
            </div>
        `;
    ...
    attachEvents() {
        this.engine.on('telemetry', (metrics, robots, tasks) => {
    ...
    updateFleetCards() {
        ...
        // Card click listeners to select robot
        list.querySelectorAll('.robot-telemetry-row').forEach(row => {
            row.addEventListener('click', () => {
                const id = row.dataset.id;
                this.engine.selectRobot(id);
            });
        });
    }
